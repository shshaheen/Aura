...
import 'package:aura/screens/feedback_screen.dart';
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: MediaQuery.of(context).size.width *
          0.70, // Reduce width to 75% of screen
      child: Drawer(
          child: Column(
        children: [
          SizedBox(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    ...
                    Theme.of(context).colorScheme.onPrimaryContainer.withAlpha(
                          (0.8 * 255).toInt(),
                        ),
                  ],
              ...
              child: InkWell(
                ...
                child: Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: 8.0, horizontal: 4.0), // Better touch area
                  child: Row(
                    children: [
                      Icon(
